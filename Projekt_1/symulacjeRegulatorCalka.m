...
paths = ["./wykresy/regulator_calka_x_1.png", "./wykresy/regulator_calka_x_2.png", "./wykresy/regulator_calka_x_3.png", "./wykresy/regulator_calka_u.png", "./wykresy/regulator_calka_y.png"];

[G_l, G_m]=transmitancja_dane();
[A, B, C, D] = transmitancja_na_przestrzen_stanu(G_l, G_m);

model = 'Uklad_Obiekt_Regulator_Calka';
X_0=[0; 0; 0];
s_bs = [-2, -10];
...
for i=1:2
    s_b = s_bs(i);
    [K_e, K]=oblicz_parametry_obserwatora_z_calkowaniem(A, B, C, s_b);
